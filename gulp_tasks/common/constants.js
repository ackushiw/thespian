...
module.exports = function() {
  ...
  var constants = {
    ...
    repository: 'https://github.com/ackushiw/thespus-ionic',
    ...
    style: {
      ...
      css: {
        src: ['./bower_components/famous-angular/dist/famous-angular.css', './bower_components/mdi/css/materialdesignicons.min.css', './bower_components/angular-material/angular-material.min.css'] // you can also add a specific src_appname
      }
    },
    ...
    serve: {
      ...
      localtunnel: false // true, false or 'thespus'
    },
    mocha: {
      libs: ['server/**/*.js'],
      tests: ['test/mocha/**/*.js'],
